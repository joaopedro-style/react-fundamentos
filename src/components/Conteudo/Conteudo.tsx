...
export default function Conteudo() {
  /* Definindo o state para categoria ativa/selecinada, 
  ...
  /* Trocando o titulo da página conforme a categoria escolhida */
  useEffect(() => {
  ...
  return (
    <>
      <section>
        ...
        <Saudacao nome="João Pedro" classe="bg-emerald-100" />
