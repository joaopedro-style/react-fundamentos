...
export default function Cabecalho() {
  ...
  No caso do useState, usamos desestruturação, criamos uma constante que representa o valor do state (titulo) e uma função responsável por atualizar o state (setTitulo) */
